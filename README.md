> **Offline Trello deployment:** This reusable copy is configured through
> `.env`. Follow
> [OFFLINE-TRELLO-RUNBOOK.md](OFFLINE-TRELLO-RUNBOOK.md) before starting it; the TLS
> files and `.env` values are intentional placeholders. This deployment uses
> the included offline Trello JSON importer and does not require Trello API
> access.
...
- 🚀 **Trello Imports**: Import Trello boards from offline JSON exports
